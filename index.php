...
<html lang="en">
  ...
  <head>
    ...
    <meta name="author" content="phibonachos">
  ...
  <body id="page-top">
    ...
    <!-- Error alert-->
    <div class="modal fade" id="errornotify" tabindex="-1" role="dialog" aria-labelledby="loginmodalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="alert alert-danger mb-0">
            <span id="message">An error occurred, please try again later</span>
                ...
                <div class="modal-header">
                    ...
                    <div class="modal-body text-center">
                        <form id="loginform" action="" method="post" class="form-signin">
                            <input type="text" class="form-control flex-fill mr-0 mr-sm-2 mb-3 mb-sm-0" id="inputUsernamelog" placeholder="Enter your username">
                            <label for="inputPassowrdlog" class="sr-only">Password</label>
                            <input type="password" class="form-control flex-fill mr-0 mr-sm-2 mb-3 mb-sm-0" id="inputPassowrdlog" placeholder="Type your password...">
                            <div class="checkbox mb3">
                              <label>
                                ...
                                <a class="btn custom-btn" data-toggle="modal" data-target="#errornotify">Log In</a>
                                <input type="submit" class="form-control btn-primary" value="Log In" data-toggle="modal" data-target="#errornotify">
                        </form>
                    </div>
              ...
              <div class="form-group">
                <div class="form-row">
                  <div class="col-md-6 mb-3">
                    <input type="email" class="form-control flex-fill mr-0 mr-sm-2 mb-3 mb-sm-0" id="inputEmail" placeholder="Enter email address..." required>
                  </div>
                  <div class="col-md-6 mb-3">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control flex-fill mr-0 mr-sm-2 mb-3 mb-sm-0" id="inputUsername" placeholder="Enter your username..." required>
                ...
                <div class="form-row">
                  <div class="col-md-6 mb-3">
                    <input type="text" class="form-control flex-fill mr-0 mr-sm-2 mb-3 mb-sm-0" id="inputName" placeholder="Enter your name..." required>
                  </div>
                  <div class="col-md-6 mb-3">
                    <input type="text" class="form-control flex-fill mr-0 mr-sm-2 mb-3 mb-sm-0" id="inputSurname" placeholder="Enter your surname..." required>
                  </div>
                </div>

                <div class="form-row">
                  <div class="col-md-6 mb-3">
                    <input type="password" class="form-control flex-fill mr-0 mr-sm-2 mb-3 mb-sm-0" id="inputPassowrd" placeholder="Type your password..." required>
                  </div>
                  <div class="col-md-6 mb-3">
                    <input type="password" class="form-control flex-fill mr-0 mr-sm-2 mb-3 mb-sm-0" id="inputConfirm" placeholder="Confirm your password..." required>
                  </div>
                </div>
              </div>
