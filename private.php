                                                    ...
                                                    <form name="addPrivileges" method = "post">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="text" class="form-control" name="userID" id="newusername" placeholder="Type a username...">
                                                                    <div class="input-group-append">
                                                                        <a style="border-radius: 0;" class="rightcorners" onclick="$('#newusername').toggleClass('is-invalid');">
                                                                            <span class="input-group-text glyphicon glyphicon-search" style="top: 0px;"></span>
                                                                        </a>
                                                                    </div>
